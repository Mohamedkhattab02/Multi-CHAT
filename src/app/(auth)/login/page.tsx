    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--background)] p-4">
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="text-center space-y-2">
          <h1 className="text-2xl font-semibold text-[var(--foreground)]">MultiChat AI</h1>
        ...
        <form onSubmit={handleEmailLogin} className="space-y-3">
          <div>
            ...
            <input
              ...
              required
              autoComplete="email"
              className="w-full px-3 py-2 text-sm border border-[var(--border)] rounded-lg bg-[var(--background)] text-[var(--foreground)] placeholder:text-[var(--muted-foreground)] focus:outline-none focus:ring-2 focus:ring-[var(--ring)] focus:border-transparent"
